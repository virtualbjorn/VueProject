...
const setOverflowHidden = (options?: BodyScrollOptions) => {
  ...
  setTimeout(() => {
    ...
    if (previousBodyOverflowSetting === undefined) {
      ...
      if (!isIosDevice) document.documentElement.style.overflow = 'hidden';
    }
  });
};
...
const restoreOverflowSetting = () => {
  ...
  setTimeout(() => {
    ...
    if (previousBodyOverflowSetting !== undefined) {
      ...
      if (!isIosDevice) document.documentElement.style.overflow = previousBodyOverflowSetting;
...
const bodyScrollLock: Plugin = (context, inject) => {
  inject('disableBodyScroll', disableBodyScroll);
  inject('enableBodyScroll', enableBodyScroll);
  inject('clearAllBodyScrollLocks', clearAllBodyScrollLocks);
}
